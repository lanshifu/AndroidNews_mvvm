...
public class ViewAdapter {
    ...
    public static void onRefreshCommand(SmartRefreshLayout smartRefreshLayout, final BindingCommand<Integer> onRefreshCommand) {
    ...
    @BindingAdapter("onLoadMoreCommand")
    public static void onLoadMoreCommand(SmartRefreshLayout smartRefreshLayout, final BindingCommand<Integer> onLoadMoreCommand) {
